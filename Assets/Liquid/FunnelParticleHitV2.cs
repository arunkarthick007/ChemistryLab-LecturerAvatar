...
public class FunnelParticleHitV2 : MonoBehaviour
{
    public ParticleSystem part;
    public List<ParticleCollisionEvent> collisionEvents;
    FunnelFlowControlV2 funnel_flow_control;
    ...
    void Start()
    {
        ...
        funnel_flow_control = separating_funnel.GetComponent<FunnelFlowControlV2>();
